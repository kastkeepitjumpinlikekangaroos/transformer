...
to four shards, exercising real nested multi-shard plans; sharded execution at K>1
is a throughput cliff, not a hard deadlock on JDK 21 (`ForkJoinTask.get()`
work-helping keeps the pool live — see [gotchas.md](gotchas.md)). Its
