...
deterministic and green in seconds, but long sharded campaigns can wedge — K>1
sharded execution has a real, reproduced hard-deadlock at campaign volume (see
[gotchas.md](gotchas.md)) — so always pass `--test_timeout`. Its
